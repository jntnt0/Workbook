EIGRP_Troubleshooting_Workflow.md

EIGRP_Troubleshooting_Workflow

# Source_Basis
| Source | Relevant Section | What It Supports |
|---|---|---|
| `_KB_INDEX.md` | Book 3: EIGRP for IP | Points EIGRP concepts, DUAL, feasible successors, metrics, convergence, summarization, filtering, redistribution, stub routing, and authentication to `All_combined_part3.md` |
| `All_combined_part3.md` | Book 3, Chapter 1: EIGRP Concepts and Technology | Supports EIGRP neighbor table, topology table, RTP, DUAL, successors, feasible successors, and metric behavior |
| `All_combined_part3.md` | Book 3, Chapter 2: Advanced EIGRP Concepts, Data Structures and Algorithms | Supports passive/active routes, query/reply behavior, feasible condition, SIA behavior, and DUAL troubleshooting |
| `All_combined_part3.md` | Book 3, Chapter 7: Route Filters | Supports distribute-list, route-map filtering, query-boundary behavior, and route-filter troubleshooting |
| `All_combined_part3.md` | Book 3, Chapter 8: Default Routes | Supports EIGRP default candidate/default route troubleshooting |
| `All_combined_part3.md` | Book 3, Chapter 9: Integrating EIGRP with Other Routing Protocols | Supports EIGRP redistribution, seed metrics, route tags, and loop-prevention troubleshooting |
| `All_combined_part3.md` | Book 3, Chapter 15: Secure EIGRP Operation | Supports EIGRP authentication troubleshooting |
| `CCNP Enterprise Advanced Routing ENARSI 300-410 Official.md` | Chapter 4: Troubleshooting EIGRP for IPv4 | Supports neighbor adjacency troubleshooting, route troubleshooting, named/classic mode checks, and EIGRP verification commands |
| `CCNP Enterprise Advanced Routing ENARSI 300-410 Official.md` | Chapter 17: Troubleshooting Redistribution | Supports redistribution, route-map, tag, metric, AD, and loop troubleshooting |
