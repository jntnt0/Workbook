...
|---|---|---|
| Microsoft Learn | Azure virtual network peering overview | VNet peering behavior, local peering, global peering, Azure backbone traffic, hub-spoke design, and non-transitive peering |
...
| Microsoft Learn | Virtual network peering requirements and constraints | Non-overlapping address spaces, same-cloud requirements, global peering constraints, and peering sync state |
...
| Microsoft Learn | Private DNS virtual network links | Registration links, resolution links, link status, autoregistration, and link behavior |
...
| Microsoft Learn | Azure PowerShell Private DNS quickstart | `New-AzPrivateDnsZone`, `New-AzPrivateDnsVirtualNetworkLink`, and private DNS record management |
...
| Azure default DNS | Good inside a VNet, but not enough for full cross-VNet name resolution design |
